        ...
        <div className="relative z-10 pb-8 bg-white sm:pb-16 md:pb-20 lg:pb-28 xl:pb-32">
          <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="sm:text-center lg:text-left">
              <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                ...
                <span className="block text-indigo-600">personalized audio content</span>
              </h1>
          ...
          <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
            <div className="h-56 w-full sm:h-72 md:h-96 lg:w-full lg:h-full flex items-center justify-center gap-8 p-8">
              <Music2 className="h-16 w-16 text-indigo-600 animate-bounce" />
              <Headphones className="h-16 w-16 text-indigo-500 animate-pulse" />
              <Radio className="h-16 w-16 text-indigo-400 animate-bounce" />
            </div>
          </div>
        </div>
      </div>
